  ...
  return (
    ...
    >
      ...
      >
        ...
        <Animated.Image
          source={require('../assets/images/wavee.png')}
          style={[styles.handImage, { transform: [{ rotate: handRotation }] }]}
        />
      </LinearGradient>

      {/* Tambahkan Link Eksternal */}
      <Link href="https://www.example.com" style={styles.linkText}>
      ...
      >
        ...
        <Image
          source={require('../assets/images/hisyam.jpeg')}
